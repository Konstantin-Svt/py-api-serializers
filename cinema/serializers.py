...
class MovieSessionListSerializer(MovieSessionSerializer):
    ...
    cinema_hall_name = serializers.PrimaryKeyRelatedField(
        source="cinema_hall.name", read_only=True
    )
    cinema_hall_capacity = serializers.PrimaryKeyRelatedField(
...
class MovieSessionCreateUpdateSerializer(MovieSessionSerializer):
